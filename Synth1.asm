; SYNTH1/PARAM1 CODE - 09 Dec 2019
...
001B : 6F 02      clr $02,x           ; clear(00) addr X + 02h (8002 PIA1 set port B in)
001D : 6F 07      clr $07,x           ; clear(00) addr X + 07h (8007 PIA2 DDR port B)
001F : 6F 06      clr $06,x           ; clear(00) addr X + 06h (8006 PIA2 set port B in)
0021 : 86 FF		  ldaa	#$FF          ; load A with FFh (1111 1111)
0023 : A7 00		  staa	$00,x         ; store A in addr X + 00h (8000 PIA1 set port A out)
0025 : 86 3C		  ldaa	#$3C          ; load A with 3Ch(0011 1100)
0027 : A7 01		  staa	$01,x         ; store A in addr X + 01h (8001 PIA1 control reg A)
0029 : 86 37      ldaa  #$37          ; load A with 37h(0011 0111)
002B : A7 03      staa  $03,x         ; store A in addr X + 03h (8003 PIA1 control reg B) 
002D : A7 07      staa  $07,x         ; store A in addr X + 07h (8007 PIA2 control reg B)
002F : 01   	    nop	        			  ; reserved, poss. PIA2 port A setup
0030 : 01         nop                 ; reserved
;*************************************;
...
00B9 : B6 80 06   ldaa X8006          ; load A with PIA2 B
