; SYNTH8 SOUNDS CODE - 15 Marv 2021
...
; ~ not used
000D : 00                             ;not used
000E : nn                             ; X changing A7,9A
000F : 00                             ;not used
0010 : 9B                             ; X
0011 : nn                             ; A changing, PIA B pitch
0012 : nn                             ; B count up 00-FF
0013 : 0F FB                          ; X
0015 : 7F                             ; A
;
0016 : 01                             ; SYNTH8 jmp dest
; write flood 01   ;  <-- wot
0022 : 01                             ; end flood
;
0023 : 91 00                          ; B
...
003C : 01 01      nop nop             ; need 8 bytes for PIA2 B init
003E : 01 01      nop nop             ;
003F : 01         nop                 ;
;*************************************;
;IRQ - reset, MAIN LOOP                
...
0043 : C6 03      ldab  #$03          ;load B with 03h
;*************************************;
;PARAM7 - modified: 
; rem beq & jmp to IRQ2/SYNTH4
;*************************************;
...
007D : 7E 00 40   jmp $0040           ;jump to IRQ (orig IRQ2/SYNTH4)
;*************************************;
...
009A : 0c 7f 1d 0f fb 7f 23 0f        ; load for PARAM7
...
0119 : CE 00 16   ldx #$0016          ;load X with 0016h
;LOOP4
...
0124 : C6 01      ldab  #$01          ;load B with value 01h (0000 0001)
0126 : E7 00      stab  $00,x         ;store B in addr X + 00h
0128 : 08         inx                 ;incr X
...
013B : E7 00      stab  $00,x         ;store B in addr X + 00h
...
014D : 89 00      adca #$00           ;add A + 00h + C into A
014F : 54         lsrb                ;lsr B
...
016C : 7E 00 16   jmp $0016           ;jump to addr 0016
;GOTO7
